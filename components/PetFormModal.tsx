             ...
             <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3"><div className="h-px bg-gray-200 flex-1"></div><span className="text-xs text-gray-400 font-bold uppercase">ALEBO</span><div className="h-px bg-gray-200 flex-1"></div></div>
                        <div>
                      ...
                      <div className="space-y-4">
                          ...
                          {health.hasAllergies && (
                              <div className="animate-in slide-in-from-top-2 duration-200">
                                  <label className="block text-xs font-bold text-gray-500 uppercase mb-1 ml-1">Popis alergií</label>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div>
                                  <label className="block text-xs font-bold text-gray-500 uppercase mb-1 ml-1 flex items-center gap-1"><Pill size={12} className="text-blue-500"/> Lieky</label>
                              ...
                              <div>
                                  <label className="block text-xs font-bold text-gray-500 uppercase mb-1 ml-1 flex items-center gap-1"><Utensils size={12} className="text-green-500"/> Špeciálna strava / Diéta</label>
