...
import { Filter, MapPin, Calendar, Ruler, Tag, X, Heart, Activity, ArrowRight, Dog, Cat } from 'lucide-react';
  ...
  return (
    <div className="bg-gray-50 min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Filters Container */}
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-10 border border-gray-100 sticky top-24 z-30 backdrop-blur-xl bg-white/95">
          <div className="flex items-center gap-2 mb-4 text-gray-700 font-medium pb-2 border-b border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div className="relative">
              <select
                ...
                className="w-full pl-3 pr-8 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none appearance-none cursor-pointer text-gray-900 font-medium transition hover:bg-white"
              >
                <option value="all">Všetky zvieratá</option>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none text-gray-900 font-medium transition hover:bg-white"
              />
            </div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full pl-10 pr-8 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none appearance-none cursor-pointer text-gray-900 font-medium transition hover:bg-white"
              >
          ...
          {(filterType !== 'all' || filterLocation !== '' || filterAge !== 'all' || filterSize !== 'all' || filterTag !== 'all') && (
             <div className="mt-4 pt-4 border-t border-gray-100 flex justify-end">
               <button 
                onClick={resetFilters}
                className="text-sm text-red-500 hover:text-red-700 flex items-center gap-1 font-bold bg-red-50 px-3 py-1.5 rounded-lg transition"
               >
                 <X size={16} /> Vymazať všetky filtre
               </button>
             </div>
          )}
        </div>
