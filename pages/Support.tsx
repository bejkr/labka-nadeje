      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
            <div className="text-center mb-12">
                <span className="text-brand-600 font-bold uppercase tracking-wider text-sm mb-2 block">Pomoc v teréne</span>
        ...
        <div className="mb-24 py-12 border-t border-gray-200">
          <div className="text-center mb-16">
            <span className="text-brand-600 font-bold uppercase tracking-wider text-sm mb-2 block">Pomoc na diaľku</span>
