...
const PetDetailPage: React.FC = () => {
  ...
  const [donationAmount] = useState<number>(10);
                    ...
                    <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="pt-4 border-t border-gray-50 flex justify-between items-center text-sm">
                                <span className="text-gray-600">Aktivita</span>
           ...
           <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden">
               {applicationSuccess ? (
                   ...
                   <form onSubmit={handleApplicationSubmit} className="p-6">
                       ...
                       <button type="submit" disabled={isSubmittingApp} className="w-full bg-brand-600 text-white font-bold py-3 rounded-xl mt-4">Odoslať</button>
                   </form>
               )}
           </div>
        </div>
